...
class DDPM:
    ...
    def _baoa_step(self, x, p, t, dt, gamma=0.1, m=1.0, kBT=1.0):
        """
        BAOA (B-A-O-A) integration step for sampling.
    ...
    def baoa_sample(self, x, t, dt, n_steps=100, gamma=0.1, m=1.0, kBT=1.0):
        """
        BAOA sampling trajectory.
        
        Args:
            x: Initial position tensor
        ...
        Returns:
            Trajectory tensor of shape (n_steps+1, batch_size, input_dim)
        """
        if len(t.shape) == 0:
